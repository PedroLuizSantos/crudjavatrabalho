...
public class CrudFuncionarioController implements Initializable {
	...
	@FXML
	 void BotaoSair(ActionEvent event) {
		dialogBoxConfirmacao("Obrigado por Testar!");
		System.exit(0);
	    }
    ...
    private void limparCadastro(){
    	IncluirnomeFuncionario.clear();
    	IncluirdataFuncionario.setValue(null);
    	IncluirsalarioFuncionario.clear();
    }
